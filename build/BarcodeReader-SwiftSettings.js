...
var HowneywellBarcodeReaderSwiftSettings = [
  ...
  },
  {
    family: 'BarcodeReader',
    key: 'Settings',
    option: 'Notification Good Read',
    valueType: 'map',
    valueMap: [{true: true}, {false: false}],
    command: 'NTF_GOOD_READ_ENABLED',
  },
  {
    family: 'BarcodeReader',
    key: 'Settings',
    option: 'Notification Bad Read',
    valueType: 'map',
    valueMap: [{true: true}, {false: false}],
    command: 'NTF_BAD_READ_ENABLED',
  },
  {
    family: 'BarcodeReader',
    key: 'Settings',
    option: 'Notification Vibrate',
    valueType: 'map',
    valueMap: [{true: true}, {false: false}],
    command: 'NTF_VIBRATE_ENABLED',
  },
  ...
  },
  {
    family: 'BarcodeReader',
    key: 'Settings',
    option: 'CenterDecodeTimeout',
    valueType: 'int',
    valueRange: [10000],
    command: 'DEC_WINDOW_TIMEOUT',
  },
];
